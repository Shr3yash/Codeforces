...
void solve() {
    ...
    int n, x;
        ...
        for (int i = 0; i < n; i++) {
            ...
            // Efficiently calculates ⌈ 𝑎 [ 𝑖 ] / 𝑥 ⌉ 
            // ⌈a[i]/x⌉ using integer operations. 
            // Avoids the overhead and potential inaccuracies of floating-point arithmetic.
        }

        long long min_beauty = (total + x - 1) / x; 
