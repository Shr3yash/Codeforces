...
void solve() {
    /*
    int toMake, from, without;
    cin>>toMake>>from>>without;
    ...
    else if(toMake%2 == 0 && without!=2){
        cout<<"Yes"<<newline;
        cout<<toMake/2<<newline;
        for(int i=0; i<toMake/2; ++i){
            cout<<"2"<<" ";
        }
        cout<<newline;
        return;
    }
    else if(toMake%2 == 1 && without!=3){
        cout<<"Yes"<<newline;
        cout<<floor(toMake/2) - 1 + 1<<newline;
        for(int i=0; i<floor(toMake/2) - 1; ++i){
            cout<<"2"<<" ";
        }
        cout<<"3"<<newline;
        return;
