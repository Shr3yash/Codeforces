...
void solve() {
    ...
    // find a pair whose gcd is less than or equals to 2 
    // because it doesnt matter if you add a number to that pair
    // if you do, it will never increase gcd.
    // adding new number into the set of numbers will never increase the gcd of that set
