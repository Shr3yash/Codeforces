...
void solve() {
    //substitute bi=ai^x, boils down to: 0 = ai^x or 0 = ai
    //XOR whole array, we get something. 
    //We need x which will help us get that zero on lhs
    //XORArr^x = 0. XORArr^0=x? if size of Arr is odd.
    //XORArr^0 = 0? if no, return -1, size of Arr is even.
